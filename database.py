...
with app.app_context():
    ...
    test_dog_3 = Dog(user_id=3, name='Lily', image_url="https://cdn.shibe.online/shibes/f1979eb7fbd217318a5a72bba5aabbd7793610ef.jpg")  # noqa
    test_dog_4 = Dog(user_id=4, name='ぎょうざ', image_url="https://cdn.shibe.online/shibes/1501d925f913dd4cc85b57b193046e5cf3fb1e15.jpg")  # noqa
    ...
    demo_post = Post(dog_id=1, image_url="https://cdn.shibe.online/shibes/a21b3d28beec5380ab9eb94b14348be0e67cfb92.jpg", body='')  # noqa
    test_post_2 = Post(dog_id=2, image_url="https://cdn.shibe.online/shibes/69901d07648a0ba1646b854c7b3114eb8cb7d5d2.jpg", body='')  # noqa
    test_post_3 = Post(dog_id=3, image_url="https://cdn.shibe.online/shibes/b68964180e052b787bf572e9de34031028fa3d67.jpg", body='')  # noqa
    test_post_4 = Post(dog_id=4, image_url="https://cdn.shibe.online/shibes/3f90d003d490dd99124c3230efbb198f85b83702.jpg", body='')  # noqa
    test_post_5 = Post(dog_id=5, image_url="https://cdn.shibe.online/shibes/faa241cee383ee408d1a93cc77b20a9a35c45ddf.jpg", body='')  # noqa
    test_post_6 = Post(dog_id=6, image_url="https://cdn.shibe.online/shibes/31b62b6a2710f865ea3ec7b87a054a7febcdf353.jpg", body='')  # noqa
    test_post_7 = Post(dog_id=7, image_url="https://cdn.shibe.online/shibes/33d520a1e70ab3ec63d2a5aeee28ab9dad4958ce.jpg", body='')  # noqa
    test_post_8 = Post(dog_id=8, image_url="https://cdn.shibe.online/shibes/4149cbc36f4b95601d576cbabb0c7a1e716c0ce1.jpg", body='')  # noqa
